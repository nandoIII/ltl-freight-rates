                            ...
                            <div id="all-divs"> <!-- all divs container -->
                                ...
                                <div id="invisible-div-1"> <!--Start of invisible-div-1 -->
                                    ...
                                    <table>
                                        ...
                                        <tr><td><div class="label_form">Origin Zipcode</div></td><td align="left"><div align="left"><input name="orig_zip" id="ltl_origin" data-or="60606"  class="txt_mid" type="text" size="25" placeholder="Origin" onkeypress="return isNumberKey(event)"></div>
                                            </td>
                                            <td><div class="label_form">Destination Zipcode</div></td><td><input name="dest_zip" id="ltl_destination" class="txt_mid" data-dt="33133" type="text" size="25" placeholder="Destination" onkeypress="return isNumberKey(event)"></td>
                                        </tr></table>                                    
                                    <table width="500px">
                                        <tr>
                                                            ...
                                                            <div style="background-color:#9797a6;width:500px">
                                                                <table width="500px">
                                                                    ...
                                                                    <tr class="fields">
                                                                        ...
                                                                        <td ><a id="add-item" type="button" style="cursor: pointer;color:rgba(255,255,255,1);text-decoration: none;" ><img id="redAdd" src="images/red-dot.png"  />Add to Quote</a>
                                                            ...
                                                            <div id="invisible-div-2">  <!--Start of invisible-div-2 -->
                                                                <div >
                                                                            ...
                                                                            <div style="background-color:rgba(238,238,238,1); border: 0.5px solid rgba(153,153,153,1); width:280px; height:190px">
                                                                                <table id="carrier-rates" width="280px">
                                                                                    <tr style="height:50px" align="center">
                                                                                        ...
                                                                                        <td><div id="rate-item"><img src="images/loading.gif" style="width:15px; height:15px" />&nbsp;</div></td></tr>
                                                                                    <tr align="center">
                                                                                        <td><div id="carrier-item">Logo&nbsp;</div></td>
                                                                                        <td><div id="transit-Days">Days&nbsp;</div></td>
                                                                                        <td><div id="rate-item"><img src="images/loading.gif" style="width:15px; height:15px" />&nbsp;</div></td></tr>
                                                                    ...
                                                                    <table style="padding-left:30px" id="buttons">
                                                                        <tr><td>&nbsp;</td></tr>
                                                                        <tr><td><div align="right" style="padding-right:50px"><button style="width:120px;" id="" class="pt-touch-button send" onclick="">RATE ANOTHER</button></div></td>
                                                                            <td><div align="right" style="padding-right:50px"><button style="width:120px;" id="" class="pt-touch-button send">SEND BY EMAIL</button></div></td>
                                                                            <td><div align="right" style="padding-right:50px"><button style="width:120px;" id="" class="pt-touch-button send" onclick="">BOOK NOW!</button></div></td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <div id="front-layer"> <!-- start front-layer --> <!-- Contact Form -->
                                                                    ...
                                                                    <div id="contact-box">
                                                                        <table id="contact-table">
                                                                           ...
                                                                           <!-- <tr><td><p id="contact_msg"></p></td></tr> -->
                                                                            <tr><td><div style="float:left" id="contact_msg"></div><div style="float:left; width:20px">&nbsp;</div><td></tr>
                                                                                        <tr>
                                                                                            <td>Contact Name</td>
                                                                                            <td>Contact Phone</td>
                                                                                        </tr>
                                                                                            ...
                                                                                            <div >
                                                                                                ...
                                                                                                <div style="float:left;" id="carriers">
                                                                                                    ...
                                                                                                    <div align="right" style="padding-right:50px">
                                                                                                        ...
                                                                                                        <div style="background-color:rgba(238,238,238,1); border: 0.5px solid rgba(153,153,153,1); width:280px; height:190px">
                                                                                                            <div id="img_loading" style="text-align: center;"><img src="images/loading.gif" style="width: 100px; height: 100px;top: 40px;position: relative;" /></div>
                                                                                                ...
                                                                                                <table style="padding-left:30px" id="buttons">
                                                                                                    ...
                                                                                                    <tr><td><div align="right" style="padding-right:50px"><button style="width:120px;" id="rate_another" class="pt-touch-button send" onclick="location.reload();">RATE ANOTHER</button></div></td>
                                                                                                        ...
                                                                                                        <td><div align="right" style="padding-right:50px"><button style="width:120px;" id="rate_another" class="pt-touch-button send" onclick="">BOOK NOW!</button></div></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                        ...
                                                                                        <div id="chatbar">
                                                                                            ...
                                                                                            <div id="chatbutton"><img src="<?php echo base_url() ?>public/images/chatbutton.png" width="220" height="75" alt="Chat Live Now!" /></div>
                                                                                        </div>
                                                                                        <div id="titleone">
